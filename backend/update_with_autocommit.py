"""
使用不同的方法更新rule_ref为"policy_ai_text_dress_clean"的system_prompt
"""
...
def update_with_autocommit():
    """使用autocommit模式更新"""
    print("=" * 100)
    print("使用autocommit模式更新rule_ref为\"policy_ai_text_dress_clean\"的system_prompt")
    print("=" * 100)
