...
def check_importer_name_column_config():
    """检查“輸入者名”这一列的field_pipelines配置"""
    print("=" * 100)
    print("检查“輸入者名”这一列的field_pipelines配置")
    print("=" * 100)
...
if __name__ == "__main__":
    check_importer_name_column_config()
