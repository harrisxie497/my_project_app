...
def check_field_pipelines_for_x_and_y():
    """检查field_pipelines中是否有X列和Y列的配置"""
    print("=" * 100)
    print("检查field_pipelines中是否有X列和Y列的配置")
    print("=" * 100)
...
if __name__ == "__main__":
    check_field_pipelines_for_x_and_y()
