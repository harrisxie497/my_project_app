...
def test_task_t_f37e2c5b():
    """测试任务ID为t_f37e2c5b的任务"""
    print("=" * 100)
    print("测试任务ID为t_f37e2c5b的任务")
    print("=" * 100)
    
    task_id = "t_f37e2c5b"
    task_dir = "C:\\Users\\harris.xie\\Documents\\trae_projects\\japan\\backend\\storage\\tasks\\t_f37e2c5b"
