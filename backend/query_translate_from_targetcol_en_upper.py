"""
查询rule_ref为"policy_translate_from_targetcol_en_upper"的规则定义
"""
...
def query_rule_definition():
    """查询rule_ref为"policy_translate_from_targetcol_en_upper"的规则定义"""
    print("=" * 100)
    print("查询rule_ref为\"policy_translate_from_targetcol_en_upper\"的规则定义")
    print("=" * 100)
    ...
    try:
        ...
        cursor.execute(sql, ('policy_translate_from_targetcol_en_upper',))
