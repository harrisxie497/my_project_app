"""
测试D列的复制问题 - 检查processed_column_data_map
"""
...
def test_d_column_processed_column_data_map():
    """测试D列的复制问题 - 检查processed_column_data_map"""
    print("=" * 100)
    print("测试D列的复制问题 - 检查processed_column_data_map")
    print("=" * 100)
    ...
    try:
        ...
        # 只处理C列和D列
        cd_pipelines = [p for p in field_pipelines_sorted if p.get('target_col') in ['C', 'D']]
...
if __name__ == "__main__":
    test_d_column_processed_column_data_map()
