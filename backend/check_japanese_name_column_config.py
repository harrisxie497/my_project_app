"""
检查“收件人名（日文）”这一列的field_pipelines配置
"""
...
def check_japanese_name_column_config():
    """检查“收件人名（日文）”这一列的field_pipelines配置"""
    print("=" * 100)
    print("检查“收件人名（日文）”这一列的field_pipelines配置")
    print("=" * 100)
...
if __name__ == "__main__":
    check_japanese_name_column_config()
